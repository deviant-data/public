...
(function () {
  ...
  function renderHistory(data) {
    ...
    root.innerHTML = '<div class="card"><h3>storage</h3><dl class="kv"><dt>database</dt><dd class="cyan">' +
      fmt(s.db_bytes || 0) + '</dd><dt>frames</dt><dd>' + fmt(s.history_frame_bytes || 0) +
      '</dd><dt>history archives</dt><dd>' + fmt(s.history_archive_bytes || 0) +
      '</dd><dt>corpus archives</dt><dd>' + fmt(s.corpus_archive_bytes || 0) +
